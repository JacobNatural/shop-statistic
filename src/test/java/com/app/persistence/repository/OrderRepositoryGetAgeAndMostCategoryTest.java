...
import static com.app.data.OrderData.ORDER_ENTITY3;
...
public class OrderRepositoryGetAgeAndMostCategoryTest {
    ...
    public void test1() {
        ...
        Assertions.assertThat(orderRepository.getAgeAndMostCategory())
                .isEqualTo(List.of());
    }

    @Test
    @DisplayName("When we have two categories in one age group, return the age with the categories.")
    public void test2() {

        orderRepository.saveAll(List.of(ORDER_ENTITY1, ORDER_ENTITY5));
        var projection = orderRepository.getAgeAndMostCategory();
    ...
    public void test3() {
        ...
        orderRepository
                .saveAll(List.of(ORDER_ENTITY1,  ORDER_ENTITY3));
